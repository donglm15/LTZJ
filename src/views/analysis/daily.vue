<template>
  <div>
    ...
    <el-table v-loading="listLoading" :data="tableData" height="385" border style="width: 100%">
      <el-table-column prop="product" label="产品名" width="120" align="center" />
      <el-table-column prop="regionType.typeName" label="地域" width="100" align="center" />
      <el-table-column prop="date" sortable label="时间" format="yyyy-MM-dd" width="130" align="center" />
      <el-table-column sortable prop="value1" label="产品计费收入(万)" width="160" align="center" />
      <el-table-column sortable prop="value2" label="新增用户数" width="120" align="center" />
      <el-table-column prop="hratio" sortable label="日均环比" width="110" align="center">
        <template slot-scope="scope">
          <el-tag :type="scope.row.hratio|readFilter">{{ scope.row.hratio }}%</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="tratio" sortable label="日均同比" width="110" align="center">
        <template slot-scope="scope">
