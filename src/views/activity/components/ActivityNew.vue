        ...
        <el-col :span="12">
          <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="80px">
            ...
            <el-form-item label="活动地址" prop="address">
              <el-cascader v-model="selectedOptions" :options="options" placeholder="选择活动地址" @change="handleChange" />
            </el-form-item>
...
export default {
  ...
  methods: {
    handleChange(value) {
      this.temp.address = CodeToText[value[0]] + ' ' + CodeToText[value[1]] + ' ' + CodeToText[value[2]]
    },
    next() {
